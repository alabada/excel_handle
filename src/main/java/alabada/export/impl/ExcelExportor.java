    ...
    private static void setCellValue(Object obj, Cell cell) throws FileExportException {
        if (obj != null) {
            ...
            if (classType.endsWith("String"))
                ...
                cell.setCellValue(alabada.util.DateUtil.dateToString((Date) obj, alabada.util.DateUtil.YYYYMMDDHHMMSS));
